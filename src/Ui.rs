...
use bevy::{a11y::accesskit::Vec2, asset::AssetServer, ecs::{component::Component, entity::{self, Entity}, system::{Commands, Res, ResMut, Resource}}, hierarchy::{BuildChildren, ChildBuilder, Parent}, prelude::default, reflect::{self, Reflect}, render::color::Color, text::{Font, Text, Text2dBundle, TextSection, TextStyle}, transform::commands, ui::{node_bundles::{ButtonBundle, NodeBundle, TextBundle}, JustifyContent, Style, UiRect, Val}};
...
pub fn render_title_screen(mut command: Commands, asset_server: Res<AssetServer>){  
    let path = "embedded://Fonts/Mira.ttf";
